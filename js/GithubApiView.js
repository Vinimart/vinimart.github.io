class GithubApiView {
    ...
    renderPortfolioError(errorMsg, name) {
        if (errorMsg === 404)
            this.portfolioContainer.insertAdjacentHTML("beforeend", this.portfolioErrorTemplate404(errorMsg, name));
        else
            this.portfolioError.innerHTML = this.portfolioErrorTemplateGeneral(errorMsg, name);
    }
...
exports.GithubApiView = GithubApiView;
